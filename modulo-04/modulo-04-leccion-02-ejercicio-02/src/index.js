...
// req=petición (request) y res= respuesta (response). Podría ser pepino
...
//ejercicio 02, si cambiamos new-user por /user/add, hay que cambiarlo también en el fetch de la petición o
